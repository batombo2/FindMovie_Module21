...
итоговое задание 28 модуль
    Задание:
        Сделать анимацию появления главного экрана при помощи Scene.
...
итоговое задание 31 модуль
    Задание:
        Кастомный прогресс-бар, который будет показывать, какой рейтинг у фильма.
        Применять толщину линии и прогресс из XML, а также устанавливать прогресс из кода.
    Дополнительное задание ✱:
