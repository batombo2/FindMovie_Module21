...
class FavoritesFragment : Fragment() , OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val favoritesFragmentRoot = view.findViewById<ConstraintLayout>(R.id.favorites_fragment_root)
        AnimationHelper.performFragmentCircularRevealAnimation(favoritesFragmentRoot, requireActivity(), 1)
